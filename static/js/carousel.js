...
if ($(".tf-sw-slideshow").length > 0) {
  var preview = $(".tf-sw-slideshow").data("preview") || 3;
  var tablet = $(".tf-sw-slideshow").data("tablet") || 2;
  var mobile = $(".tf-sw-slideshow").data("mobile") || 1;
  var spacing = $(".tf-sw-slideshow").data("space") || 0;
