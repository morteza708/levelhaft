...
class CustomerProfile(models.Model):
    ...
    clinic_name = models.CharField(max_length=100, blank=False, null=False, default='', verbose_name="نام کلینیک")
    activity_city = models.CharField(max_length=50, blank=False, null=False, default='', verbose_name="شهر محل فعالیت")
    activity_history = models.CharField(max_length=100, blank=False, null=False, default='', verbose_name="سابقه فعالیت")
    brand_used = models.CharField(max_length=255, blank=False, null=False, default='',
                                  verbose_name="چه برند هایی تاکنون استفاده کرده اید؟")
    instagram_url = models.CharField(max_length=255, blank=False, null=False, default='', verbose_name="لینک پیج اینستاگرام")
